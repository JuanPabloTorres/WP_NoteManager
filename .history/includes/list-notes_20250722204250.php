        ...
        <div class="nr-modal-wrapper">
            <div class="nr-modal-content">
                ...
                <div class="nr-modal-body">
                    ...
                    <p id="nr-modal-desc" class="nr-modal-description">¿Estás seguro de que deseas eliminar esta nota "<?php echo esc_html($nota->titulo); ?>"? Esta acción no se puede deshacer.</p>
                </div>
