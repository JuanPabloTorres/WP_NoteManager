...
function nr_crear_categorias_por_defecto() {
    $categorias_default = [
        'Personal' => 'Notas personales y recordatorios',
        'Trabajo' => 'Notas relacionadas con el trabajo',
        'Ideas' => 'Ideas y proyectos futuros',
        'Tareas' => 'Lista de tareas pendientes',
        'Importante' => 'Notas importantes y urgentes'
    ];
    
    foreach ($categorias_default as $nombre => $descripcion) {
...
// Crear categorías por defecto al activar el plugin
add_action('init', 'nr_crear_categorias_por_defecto', 30);
