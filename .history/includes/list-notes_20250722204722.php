...
function nr_render_list_notes($notas) {
    ...
    foreach ($notas as $nota) {
        ...
        echo '<a href="#" class="button button-delete-nota" data-id="' . esc_attr($nota->id) . '" data-title="' . esc_attr($nota->titulo) . '>❌ Eliminar</a>';
    ...
    <div class="nr-modal-wrapper">
        <div class="nr-modal-content">
            ...
            <div class="nr-modal-body">
                ...
                <p id="nr-modal-desc" class="nr-modal-description">
                    ¿Estás seguro de que deseas eliminar la nota <strong id="nr-note-title">[Título de nota]</strong>? Esta acción no se puede deshacer.
                </p>
            </div>
            <div class="nr-modal-footer">
                ...
                <button type="button" id="nr-confirm-delete" class="nr-btn nr-btn-danger" data-id="">
