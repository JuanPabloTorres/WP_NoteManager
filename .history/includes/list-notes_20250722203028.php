...
function nr_render_list_notes($notas) {
    ...
    foreach ($notas as $nota) {
        ...
        <a href="#" 
        class="button button-delete-nota" 
        data-id="' . esc_attr($nota->id) . '"
        style="color:#e53935;">❌ Eliminar</a>
    ...
    echo '
<div id="nr-modal-confirm" style="display:none;" class="nr-modal">
    <div class="nr-modal-content">
        <p>¿Estás seguro de eliminar esta nota?</p>
        <div class="nr-modal-actions">
            <a href="#" id="nr-confirm-delete" class="button button-primary">Sí, eliminar</a>
            <a href="#" id="nr-cancel-delete" class="button button-secondary">Cancelar</a>
        </div>
    </div>
</div>';
